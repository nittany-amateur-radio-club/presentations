...
- Penn State Amateur Radio Club Faculty Advisor
...
```{r, out.width="400px"}
knitr::include_graphics("http://www.arrl.org/img/130x97/exact/News/Orlando%202017%20Collegiate%20Forum-2.JPG")
```
...
- Penn State Amateur Radio Club, <k3cr@psu.edu>
- Nittany Amateur Radio Club, <k3rog@arrl.net>
